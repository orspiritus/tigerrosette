import{by as e}from"./pointsCloudSystem-2vcS-S4d.js";const l="decalFragment",D=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=D);const t="reflectionFunction",S=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const P={name:t,shader:S},k=Object.freeze(Object.defineProperty({__proto__:null,reflectionFunctionWGSL:P},Symbol.toStringTag,{value:"Module"})),r="imageProcessingDeclaration",g=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=g);const E={name:r,shader:g},V=Object.freeze(Object.defineProperty({__proto__:null,imageProcessingDeclarationWGSL:E},Symbol.toStringTag,{value:"Module"})),a="lightUboDeclaration",x=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=x);const y={name:a,shader:x},B=Object.freeze(Object.defineProperty({__proto__:null,lightUboDeclarationWGSL:y},Symbol.toStringTag,{value:"Module"})),v="ltcHelperFunctions",A=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=A);const o="shadowsFragmentFunctions",w=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=w);const M={name:o,shader:w},Y=Object.freeze(Object.defineProperty({__proto__:null,shadowsFragmentFunctionsWGSL:M},Symbol.toStringTag,{value:"Module"})),i="imageProcessingFunctions",T=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=T);const F={name:i,shader:T},j=Object.freeze(Object.defineProperty({__proto__:null,imageProcessingFunctionsWGSL:F},Symbol.toStringTag,{value:"Module"})),f="lightFragment",L=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=L);const _={name:f,shader:L},$=Object.freeze(Object.defineProperty({__proto__:null,lightFragmentWGSL:_},Symbol.toStringTag,{value:"Module"})),h="prePassDeclaration",b=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=b);const c="oitDeclaration",O=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=O);const p="samplerFragmentDeclaration",N=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=N);const s="bumpFragmentMainFunctions",X=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=X);const z={name:s,shader:X},Z=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentMainFunctionsWGSL:z},Symbol.toStringTag,{value:"Module"})),n="bumpFragmentFunctions",I=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=I);const R={name:n,shader:I},q=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentFunctionsWGSL:R},Symbol.toStringTag,{value:"Module"})),d="bumpFragment",C=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=C);const W={name:d,shader:C},Q=Object.freeze(Object.defineProperty({__proto__:null,bumpFragmentWGSL:W},Symbol.toStringTag,{value:"Module"})),u="depthPrePass",U=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=U);const m="oitFragment",H=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=H);export{F as a,W as b,z as c,R as d,y as e,k as f,V as g,B as h,E as i,Y as j,j as k,_ as l,$ as m,Z as n,q as o,Q as p,P as r,M as s};
//# sourceMappingURL=oitFragment-COwarqmx.js.map
