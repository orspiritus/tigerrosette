import{by as e}from"./pointsCloudSystem-2vcS-S4d.js";import"./oitFragment-C1qnXpVq.js";import"./defaultUboDeclaration-mfzMqo_r.js";import"./mainUVVaryingDeclaration-BftUusui.js";const i="lightsFragmentFunctions",f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=f);const l={name:i,shader:f},m=Object.freeze(Object.defineProperty({__proto__:null,lightsFragmentFunctions:l},Symbol.toStringTag,{value:"Module"})),r="fresnelFunction",a=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=a);const n="defaultFragmentDeclaration",c=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);const o="defaultPixelShader",t=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=t);const d={name:o,shader:t},C=Object.freeze(Object.defineProperty({__proto__:null,defaultPixelShader:d},Symbol.toStringTag,{value:"Module"}));export{m as a,C as b,d,l};
//# sourceMappingURL=default.fragment-CtvPXGlm.js.map
